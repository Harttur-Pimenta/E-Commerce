...
$sqlProdutos = "SELECT * FROM produtos WHERE categoria = 'Acessorios' ORDER BY id DESC";
...
<main class="main">
        <div class="container">
            ...
            <div>
                <h1 class="page-title"><span>Acessorios </span></h1>
            </div>
            ...
            <div class="section-label" style="margin-top:2rem;">
                📦 Todos os Produtos de Acessórios
            </div>
